...
debater = Blueprint('debater', __name__, url_prefix='/debater' , template_folder='templates')

@debater.before_request
def before_request():
    if current_user is not None and current_user.is_authenticated():
        if (current_user.user_type != 'debater'):
            flash('Nu sunteti debater','error')
