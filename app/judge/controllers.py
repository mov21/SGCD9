...
judge = Blueprint('judge', __name__, url_prefix='/judge' , template_folder='templates')


@judge.before_request
def before_request():
    if current_user is not None and current_user.is_authenticated():
        if (current_user.user_type != 'judge'):
            flash('Nu sunteti arbitru!','error')
...
@judge.route('/about')
@login_required
def judge_about_sfantu_gheorghe():
